...
@register_tool
class PersonalityQuarkListTool(BaseTool):
    """List available personality categories and data store counts."""

    @property
    def name(self) -> str:
        return "personality_quark_list"
    ...
    def description(self) -> str:
        return (
            ...
            "and reaction pattern counts. Use before personality_quark_read "
        ...
        try:
            async with pool.acquire() as conn:
                ...
                quote_count = await conn.fetchval(
                    "SELECT COUNT(*) FROM personality_quark_quotes WHERE profile_slug = $1",
                    profile_slug,
                )
            ...
            log.error("personality_quark_list_error", error=str(e))
