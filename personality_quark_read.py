"""
personality_quark_read — retrieve personality data across all four stores.
...
@register_tool
class PersonalityQuarkReadTool(BaseTool):
    """Load Quark personality traits, quotes, lexicon, and reactions."""

    @property
    def name(self) -> str:
        return "personality_quark_read"

    @property
    def description(self) -> str:
        return (
            "Load Quark personality data for the given categories. "
    ...
    async def execute(
        ...
        **kwargs,
        ...
        log.info("personality_quark_read",
        ...
        try:
            ...
            try:
                ...
                await log_tool_activity(
                    tool_name="personality_quark_read",
            ...
            log.error("personality_quark_read_error", error=str(e))
