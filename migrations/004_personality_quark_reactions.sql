-- Personality Quark: Reactions table
-- Trigger → response pattern mappings for contextual behavior.

CREATE TABLE IF NOT EXISTS personality_quark_reactions (
...
CREATE INDEX IF NOT EXISTS idx_pq_reactions_profile
    ON personality_quark_reactions(profile_slug);
CREATE INDEX IF NOT EXISTS idx_pq_reactions_trigger
    ON personality_quark_reactions(profile_slug, trigger_type);
CREATE INDEX IF NOT EXISTS idx_pq_reactions_intensity
    ON personality_quark_reactions(profile_slug, intensity);
CREATE INDEX IF NOT EXISTS idx_pq_reactions_tags
    ON personality_quark_reactions USING GIN(tags);
